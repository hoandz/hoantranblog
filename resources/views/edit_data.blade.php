	...
	<div class="bai_viet_moi">
		<div class="container editer">	
            ...
            <form action="{{url('update')}}/{{$post->id}}" method="post" >
                @csrf
                <input type="text" name="title" class="nhap_tieu_de" value="{{$post->title}}" >
                ...
                <input type="text" name="quote_content" class="nhap_tieu_de" value="{{$post->quote_content}}">
                <h2>Nhập tóm tắt bài viết tại đây</h2>
                <input type="text" name="summary_content" class="nhap_tieu_de" value="{{$post->summary_content}}">
